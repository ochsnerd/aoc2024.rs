...
//   all this overengineering results is only
...
mod tests {
    ...
    // #[test]
    // fn test_points_to_line() {
    //     // Test vertical lines (Up direction)
    //     let line = points_to_line((5, 10), (5, 3));
    //     assert_eq!(line, (Direction::Up, -5, (-10, -3)));

    //     let line = points_to_line((0, 8), (0, 2));
    //     assert_eq!(line, (Direction::Up, 0, (-8, -2)));

    //     // Test vertical lines (Down direction)
    //     let line = points_to_line((3, 1), (3, 7));
    //     assert_eq!(line, (Direction::Down, 3, (1, 7)));

    //     let line = points_to_line((0, 0), (0, 5));
    //     assert_eq!(line, (Direction::Down, 0, (0, 5)));

    //     // Test horizontal lines (Left direction)
    //     let line = points_to_line((8, 3), (2, 3));
    //     assert_eq!(line, (Direction::Left, 3, (-8, -2)));

    //     let line = points_to_line((5, 0), (1, 0));
    //     assert_eq!(line, (Direction::Left, 0, (-5, -1)));

    //     // Test horizontal lines (Right direction)
    //     let line = points_to_line((1, 4), (6, 4));
    //     assert_eq!(line, (Direction::Right, -4, (1, 6)));

    //     let line = points_to_line((0, 2), (8, 2));
    //     assert_eq!(line, (Direction::Right, -2, (0, 8)));
    // }
}
